 ...
 * @param <T>
 */
public class WSRestGenericRepositoryJPA<T> implements GenericRepository<T> {
    ...
    public WSRestGenericRepositoryJPA() {
    ...
    public T find(final Object id) {
        ...
        try {
            ...
            System.out.println("com.co.ebs.wlosomec.general.WSRestGenericRepositoryJPA.find()=>" + e.getCause());
        } finally {
            connDBJPA.closeEntityManager();
            if (this.entityManager != null) {
                if (this.entityManager.isOpen()) {
