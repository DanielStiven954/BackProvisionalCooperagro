 ...
 * @author YO
 */
public class ResponseListPqrsrf {
    
    private int iCodigo;
    private Boolean bRta;
    private String sMsj;
    private List<Pqrsf> listPqrsf;
    ...
    public List<Pqrsf> getListPqrsf() {
        return listPqrsf;
    }

    public void setListPqrsf(List<Pqrsf> listPqrsf) {
        this.listPqrsf = listPqrsf;
    }
